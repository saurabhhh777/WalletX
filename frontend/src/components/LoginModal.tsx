   ...
   <div className="bg-white rounded-xl p-8 max-w-md w-full mx-4 relative">
    ...
    <div className="space-y-4">
     ...
     <button
      ...
      className="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 flex items-center justify-center space-x-3 hover:bg-white transition-colors font-medium font-poppins"
     >
