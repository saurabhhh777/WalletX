    ...
    <div className="flex justify-center space-x-4 mb-16">
     {isAuthenticated ? (
      <>
       ...
       <button
        onClick={() => window.location.href = '/profile'}
        className="bg-white text-black px-8 py-4 rounded-lg font-semibold text-lg border border-gray-300 hover:bg-gray-50 transition-colors flex items-center space-x-2"
       >
      ...
      <>
       ...
       <button className="bg-white text-black px-8 py-4 rounded-lg font-semibold text-lg border border-gray-300 hover:bg-gray-50 transition-colors flex items-center space-x-2">
