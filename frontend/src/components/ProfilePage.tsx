  ...
  return (
    <div className="min-h-screen bg-white font-poppins">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 font-jost">Profile</h1>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              <h2 className="text-3xl font-bold text-gray-900 font-jost mb-2">{user.name}</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-900 font-mulish">{new Date(user.createdAt).toLocaleDateString()}</p>
            </div>
          </div>
        </div>
        ...
        {user.wallets && (
          <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
            <h3 className="text-xl font-bold text-gray-900 font-jost mb-4">Connected Wallets</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {user.wallets.ethereum && (
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">Ethereum Wallet</h4>
              ...
              {user.wallets.solana && (
                <div className="border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">Solana Wallet</h4>
                  <p className="text-sm text-gray-600 font-mulish">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6">
          <h3 className="text-xl font-bold text-gray-900 font-jost mb-4">Account Actions</h3>
