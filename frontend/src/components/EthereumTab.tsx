  ...
  return (
   <div className="space-y-6 font-poppins">
    <div className="bg-blue-50 rounded-xl p-6 border border-blue-200 text-center">
     ...
     <h3 className="text-lg font-bold text-black mb-2 font-jost">Loading Your Ethereum Wallet</h3>
     <p className="text-gray-600 font-mulish">
 ...
 return (
  <div className="space-y-6 font-poppins">
   ...
   <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Current ETH Price</h3>
    <CryptoPriceTicker />
   </div>
   ...
   {/* Receive Section */}
   <div className="bg-white rounded-xl p-6">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Receive ETH</h3>
    <p className="text-gray-600 mb-4 font-mulish">
   ...
   <div className="bg-white rounded-xl p-6">
    ...
    <div className="space-y-4">
     ...
     <div>
      <label className="block text-sm font-medium text-black mb-2 font-poppins">Amount (ETH)</label>
      <input
       type="number"
       value={amount}
