...
export const SolanaTab: React.FC = () => {
  ...
  return (
   <div className="space-y-6 font-poppins">
    <div className="bg-purple-50 rounded-xl p-6 border border-purple-200 text-center">
     ...
     <h3 className="text-lg font-bold text-black mb-2 font-jost">Sign In to Access Your Wallet</h3>
 ...
 if (!solanaWallet) {
  return (
   <div className="space-y-6 font-poppins">
    <div className="bg-purple-50 /20 rounded-xl p-6 border border-purple-200 text-center">
     <div className="w-16 h-16 bg-purple-100 dark:bg-purple-800 rounded-full flex items-center justify-center mx-auto mb-4">
      <Wallet className="w-8 h-8 text-purple-600 " />
     </div>
     <h3 className="text-lg font-bold text-black mb-2 font-jost">Loading Your Solana Wallet</h3>
     <p className="text-gray-600 font-mulish">
    ...
    <div className="bg-white rounded-xl p-6 border border-gray-200">
     <h3 className="text-lg font-bold text-black mb-4 font-jost">Import Different Wallet (Optional)</h3>
     ...
     <div className="space-y-4">
      <div>
       ...
       <input
        ...
        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent font-mulish bg-white text-black placeholder-gray-500 "
       />
      </div>
      <button
 ...
 return (
  <div className="space-y-6 font-poppins">
   {/* Current SOL Price */}
   <div className="bg-purple-50 /20 rounded-xl p-6 border border-purple-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Current SOL Price</h3>
    <CryptoPriceTicker />
   </div>

   {/* Network Status */}
   <div className="bg-blue-50 /20 rounded-xl p-6 border border-blue-200">
   ...
   {/* Wallet Info */}
   <div className="bg-white rounded-xl p-6 border border-gray-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Wallet Information</h3>
    <div className="space-y-3 font-mulish">
     <div className="flex items-center justify-between">
      <span className="text-gray-600">Address:</span>
      <div className="flex items-center space-x-2">
       <span className="font-mono text-sm text-black">{solanaWallet.address}</span>
       <button
        onClick={() => copyToClipboard(solanaWallet.address)}
        className="text-purple-600 hover:text-purple-700 dark:hover:text-purple-300"
       >
     ...
     <div className="flex items-center justify-between">
      ...
      <span className="font-semibold text-black">{solanaWallet.balance} SOL</span>
     </div>
    </div>
   </div>
   ...
   {/* Receive Section */}
   <div className="bg-white rounded-xl p-6 border border-gray-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Receive SOL</h3>
    <p className="text-gray-600 mb-4 font-mulish">
   ...
   {/* Request Airdrop */}
   <div className="bg-white rounded-xl p-6 border border-gray-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Request Test Airdrop</h3>
    <p className="text-gray-600 mb-4 font-mulish">
   ...
   {/* Send Transaction */}
   <div className="bg-white rounded-xl p-6 border border-gray-200">
    <h3 className="text-lg font-bold text-black mb-4 font-jost">Send Transaction</h3>
    <div className="space-y-4">
     <div>
      <label className="block text-sm font-medium text-black mb-2 font-poppins">Recipient Address</label>
      <input
       type="text"
     ...
     <div>
      <label className="block text-sm font-medium text-black mb-2 font-poppins">Amount (SOL)</label>
      <input
       type="number"
       value={amount}
