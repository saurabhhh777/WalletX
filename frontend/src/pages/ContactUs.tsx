  ...
  <div className="min-h-screen bg-white font-poppins">
   <div className="max-w-6xl mx-auto p-6">
    ...
    <div className="flex items-center mb-8">
     ...
     <h1 className="text-3xl font-bold text-black font-jost">Contact Us</h1>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
     ...
     <div className="space-y-6">
      <div className="bg-white rounded-xl p-8 shadow-sm">
       <h2 className="text-2xl font-bold text-black mb-6 font-jost">Get in Touch</h2>
       ...
       <div className="space-y-6">
        <div className="flex items-start space-x-4">
         ...
         <div>
          <h3 className="text-lg font-semibold text-black font-jost">Email Support</h3>
        ...
        <div className="flex items-start space-x-4">
         ...
         <div>
          <h3 className="text-lg font-semibold text-black font-jost">Live Chat</h3>
        ...
        <div className="flex items-start space-x-4">
         ...
         <div>
          <h3 className="text-lg font-semibold text-black font-jost">Phone Support</h3>
        ...
        <div className="flex items-start space-x-4">
         ...
         <div>
          <h3 className="text-lg font-semibold text-black font-jost">Office Address</h3>
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm">
       <h2 className="text-2xl font-bold text-black mb-6 font-jost">Frequently Asked Questions</h2>
       <div className="space-y-4">
        <div className="border-b border-gray-200 pb-4">
         <h3 className="text-lg font-semibold text-black mb-2 font-jost">How do I create a wallet?</h3>
        ...
        <div className="border-b border-gray-200 pb-4">
         <h3 className="text-lg font-semibold text-black mb-2 font-jost">Is my wallet secure?</h3>
         <p className="text-gray-600 font-mulish">
          Yes! WalletX stores all your data locally in your browser. We never have access to your private keys or wallet data.
         </p>
        </div>
        <div className="border-b border-gray-200 pb-4">
         <h3 className="text-lg font-semibold text-black mb-2 font-jost">Can I use multiple networks?</h3>
         <p className="text-gray-600 font-mulish">
     ...
     {/* Contact Form */}
     <div className="bg-white rounded-xl p-8 shadow-sm">
      <h2 className="text-2xl font-bold text-black mb-6 font-jost">Send us a Message</h2>
      
      <form onSubmit={handleSubmit} className="space-y-6">
       <div>
        <label htmlFor="name" className="block text-sm font-medium text-black mb-2 font-poppins">
         Full Name *
        </label>
        <input
         type="text"
       ...
       <div>
        <label htmlFor="email" className="block text-sm font-medium text-black mb-2 font-poppins">
         Email Address *
        </label>
        <input
         type="email"
       ...
       <div>
        <label htmlFor="subject" className="block text-sm font-medium text-black mb-2 font-poppins">
         Subject *
        </label>
        <select
         id="subject"
       ...
       <div>
        <label htmlFor="message" className="block text-sm font-medium text-black mb-2 font-poppins">
         Message *
        </label>
        <textarea
         id="message"
