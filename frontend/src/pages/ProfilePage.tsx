      ...
      <div className="bg-white rounded-2xl p-8 shadow-lg">
       ...
       <div className="space-y-3">
        ...
        <button
         ...
         className="bg-gray-100 text-black px-6 py-3 rounded-lg font-medium hover:bg-gray-200 transition-colors w-full"
        >
         Refresh Page
        </button>
       </div>
   ...
   <div className="min-h-screen bg-white font-poppins">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
     <div className="text-center">
      <div className="bg-white rounded-2xl p-8 shadow-lg">
       <User className="w-16 h-16 text-gray-400 mx-auto mb-4" />
       <h2 className="text-2xl font-bold text-black mb-2">User Data Not Found</h2>
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
     <div className="flex justify-between items-center py-6">
      <div className="flex items-center space-x-4">
       ...
       <div>
        <h1 className="text-3xl font-bold text-black font-jost">Profile</h1>
   ...
   <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
     ...
     <div className="lg:col-span-2 space-y-6">
       ...
       <div className="flex items-start space-x-6">
        ...
        <div className="flex-1">
         <div className="flex items-center space-x-3 mb-3">
          <h2 className="text-4xl font-bold text-black font-jost">{user.name}</h2>
      ...
      {/* Account Information */}
      <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
       <h3 className="text-2xl font-bold text-black font-jost mb-6 flex items-center">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
         ...
         <div>
          ...
          <div className="bg-white rounded-lg p-3 border border-gray-200">
           <p className="text-black font-mulish">{new Date(user.createdAt).toLocaleDateString('en-US', { 
            year: 'numeric', 
            month: 'long', 
            day: 'numeric' 
           })}</p>
      ...
      <div className="border border-gray-200 rounded-xl p-6">
       <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
         ...
         <div>
          <h4 className="font-semibold text-black">Google Account</h4>
      ...
      <div className="border border-gray-200 rounded-xl p-6">
       <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
         ...
         <div>
          <h4 className="font-semibold text-black">GitHub Account</h4>
    ...
    {/* Wallet Information */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         {ethereumWallet && (
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
           <div className="flex items-center justify-between mb-4">
            <h4 className="font-bold text-black text-lg">Ethereum Wallet</h4>
           ...
           <div className="space-y-3">
            ...
            <div>
             <label className="block text-sm font-medium text-black mb-1">Balance</label>
             <p className="text-lg font-bold text-black">{ethereumWallet.balance} ETH</p>
            </div>
           </div>
          </div>
         )}
         {solanaWallet && (
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
           <div className="flex items-center justify-between mb-4">
            <h4 className="font-bold text-black text-lg">Solana Wallet</h4>
            <div className="w-3 h-3 bg-green-500 rounded-full"></div>
           </div>
           <div className="space-y-3">
            <div>
            ...
            <div>
             <label className="block text-sm font-medium text-black mb-1">Balance</label>
             <p className="text-lg font-bold text-black">{solanaWallet.balance} SOL</p>
            </div>
           </div>
          </div>
         )}
     ...
     <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
       ...
       <div className="space-y-3">
        ...
        <button
         ...
         className="w-full bg-gray-100 text-black py-3 px-4 rounded-xl font-medium hover:bg-gray-200 transition-colors flex items-center justify-center space-x-2"
        >
      ...
      <div className="bg-white rounded-2xl p-6 border border-blue-200">
       <h3 className="text-lg font-bold text-black mb-3">Need Help?</h3>
       ...
       <div className="space-y-2">
        ...
        <button
         ...
         className="w-full bg-white text-blue-600 py-2 px-4 rounded-lg text-sm font-medium hover:bg-white transition-colors border border-blue-200"
        >
         Contact Support
        </button>
       </div>
