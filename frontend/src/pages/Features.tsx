    ...
    <div className="min-h-screen bg-gray-50 font-poppins">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 font-jost">Features</h1>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 font-jost text-center">Core Features</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">Multi-Chain Support</h3>
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">Send & Receive</h3>
                <p className="text-gray-600 font-mulish">
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">QR Code Integration</h3>
                <p className="text-gray-600 font-mulish">
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">Network Settings</h3>
                <p className="text-gray-600 font-mulish">
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">Enhanced Security</h3>
                <p className="text-gray-600 font-mulish">
              ...
              <div className="text-center p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-3 font-jost">Testnet Support</h3>
                <p className="text-gray-600 font-mulish">
          ...
          {/* Advanced Features */}
          <div className="bg-white rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 font-jost text-center">Advanced Features</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Cross-Network Compatibility</h3>
                    <p className="text-gray-600 font-mulish">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Responsive Design</h3>
                    <p className="text-gray-600 font-mulish">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Private Key Management</h3>
                    <p className="text-gray-600 font-mulish">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Real-Time Updates</h3>
                    <p className="text-gray-600 font-mulish">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Transaction History</h3>
                    <p className="text-gray-600 font-mulish">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Customizable Settings</h3>
                    <p className="text-gray-600 font-mulish">
          ...
          {/* Feature Comparison */}
          <div className="bg-white rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 font-jost text-center">Feature Comparison</h2>
            
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-4 px-6 font-semibold text-gray-900 font-jost">Feature</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Wallet Creation</td>
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Wallet Import</td>
                    <td className="py-4 px-6 text-center">
                      <div className="w-4 h-4 bg-green-500 rounded-full mx-auto"></div>
                    </td>
                    <td className="py-4 px-6 text-center">
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Send Transactions</td>
                    <td className="py-4 px-6 text-center">
                      <div className="w-4 h-4 bg-green-500 rounded-full mx-auto"></div>
                    </td>
                    <td className="py-4 px-6 text-center">
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Receive Payments</td>
                    <td className="py-4 px-6 text-center">
                      <div className="w-4 h-4 bg-green-500 rounded-full mx-auto"></div>
                    </td>
                    <td className="py-4 px-6 text-center">
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">QR Code Support</td>
                    <td className="py-4 px-6 text-center">
                      <div className="w-4 h-4 bg-green-500 rounded-full mx-auto"></div>
                    </td>
                    <td className="py-4 px-6 text-center">
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Testnet Airdrops</td>
                    <td className="py-4 px-6 text-center">
                  ...
                  <tr>
                    <td className="py-4 px-6 font-medium text-gray-900 font-mulish">Multiple Networks</td>
                    <td className="py-4 px-6 text-center">
                      <div className="w-4 h-4 bg-green-500 rounded-full mx-auto"></div>
                    </td>
                    <td className="py-4 px-6 text-center">
