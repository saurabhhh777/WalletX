    ...
    <div className="min-h-screen bg-gray-50 font-poppins">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 font-jost">Help Center</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl p-6 shadow-sm sticky top-8">
              <h2 className="text-lg font-bold text-gray-900 mb-4 font-jost">Categories</h2>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 font-jost">
              ...
              {filteredFAQs.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">No results found</h3>
                ...
                <div className="space-y-4">
                  {filteredFAQs.map((item, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg">
                      ...
                      >
                        <h3 className="text-lg font-semibold text-gray-900 font-jost pr-4">
                          {item.question}
                        </h3>
                      ...
                      {expandedItems.includes(index) && (
                        <div className="px-6 pb-6">
                          <p className="text-gray-700 font-mulish leading-relaxed">
                            {item.answer}
                          </p>
                        </div>
                      )}
            ...
            <div className="mt-8 bg-white rounded-xl p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 font-jost">Still Need Help?</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Contact Support</h3>
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 font-jost">Community Forum</h3>
                  <p className="text-gray-600 mb-4 font-mulish">
